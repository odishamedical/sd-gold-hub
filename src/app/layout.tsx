        ...
        <div className="bg-[#060A14] relative border-t border-[#C5A059]/30 text-white py-12 px-4 md:px-8 z-50 mt-auto overflow-hidden">
          ...
          <div className="max-w-[1400px] mx-auto flex flex-col gap-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              {/* 1. Gold Hub */}
              <a href="https://sd-gold-hub.vercel.app" className="group relative overflow-hidden bg-white/5 hover:bg-white/10 backdrop-blur-xl border border-white/10 hover:border-[#C5A059]/50 p-5 rounded-2xl transition-all shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] hover:shadow-[0_8px_32px_0_rgba(197,160,89,0.2)] flex flex-col justify-between gap-3">
              ...
              {/* 2. Bhulia Hub */}
              <a href="https://sd-bhulia-hub.vercel.app" className="group relative overflow-hidden bg-white/5 hover:bg-white/10 backdrop-blur-xl border border-white/10 hover:border-red-500/50 p-5 rounded-2xl transition-all shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] hover:shadow-[0_8px_32px_0_rgba(239,68,68,0.15)] flex flex-col justify-between gap-3">
              ...
              {/* 3. Dehapa Hub */}
              <a href="https://sd-dehapa-hub.vercel.app" className="group relative overflow-hidden bg-white/5 hover:bg-white/10 backdrop-blur-xl border border-white/10 hover:border-blue-400/50 p-5 rounded-2xl transition-all shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] hover:shadow-[0_8px_32px_0_rgba(96,165,250,0.15)] flex flex-col justify-between gap-3">
              ...
              {/* 4. IT Hub */}
              <a href="https://sd-it-hub.vercel.app" className="group relative overflow-hidden bg-white/5 hover:bg-white/10 backdrop-blur-xl border border-white/10 hover:border-emerald-400/50 p-5 rounded-2xl transition-all shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] hover:shadow-[0_8px_32px_0_rgba(52,211,153,0.15)] flex flex-col justify-between gap-3">
