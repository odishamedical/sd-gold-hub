...
export default function AccountsPage() {
  ...
  const renderContent = () => {
    return (
      ...
      {/* Main Wrapper */}
      <div className="relative w-full max-w-7xl mx-auto bg-white rounded-none md:rounded-2xl border border-[#C5A059]/30 shadow-[0_0_40px_rgba(197,160,89,0.15)] z-10 flex flex-col overflow-hidden animate-in fade-in duration-500 my-8">
        
        {/* Main Content Area */}
        <div className="p-4 md:p-8 flex flex-col gap-12">
          
          {/* Title Banner */}
          <div className="bg-gradient-to-r from-gray-50 via-white to-gray-50 border border-[#C5A059]/40 rounded-2xl p-6 md:p-8 shadow-[0_0_30px_rgba(197,160,89,0.1)] flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              ...
              <p className="text-xs md:text-sm text-gray-500 max-w-xl leading-relaxed">Manage your persistent Google Gmail authentication session, track Sequel Armored transit requisitions, and configure live push notification preferences.</p>
            </div>
            <div className="flex items-center gap-4 bg-white border border-gray-200 p-4 rounded-xl shadow-inner w-full md:w-auto font-sans">
               {currentUserAvatar ? (
                 ...
                 <div className="w-12 h-12 rounded-full bg-gray-50 border border-[#C5A059] flex items-center justify-center text-[#C5A059] font-bold text-lg font-mono shrink-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 flex flex-col gap-8 shadow-2xl relative overflow-hidden group hover:border-[#C5A059]/50 transition-colors">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex gap-2">
                  <input 
                    ...
                    className="bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl px-4 py-3 flex-1 focus:outline-none focus:border-[#C5A059] font-mono tracking-wider uppercase"
                  />
                  <button 
              ...
              {searched && (
                <div className="animate-in fade-in duration-300 border-t border-gray-200 pt-6">
                  {trackingResult ? (
                    <div className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col gap-6 shadow-inner">
                      ...
                      <div className="flex justify-between items-center border-b border-gray-200 pb-4">
                        <div>
                          ...
                          <span className="text-gray-900 font-mono font-bold text-base">{trackingResult.orderId}</span>
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-xs">
                        <div className="bg-gray-50 border border-gray-200 p-3 rounded-lg flex flex-col gap-1">
                          <span className="text-[10px] text-gray-500 uppercase tracking-widest">Armored Partner</span>
                          <span className="text-gray-900 font-bold">{trackingResult.courier}</span>
                        ...
                        <div className="bg-gray-50 border border-gray-200 p-3 rounded-lg flex flex-col gap-1">
                          ...
                          <span className="text-gray-900 font-bold">{trackingResult.estimatedDelivery}</span>
                      ...
                      <div className="flex flex-col gap-3 text-xs">
                        <div className="flex items-center gap-2 bg-gray-50 border border-gray-200 p-3 rounded-lg">
                          ...
                          <span className="text-gray-700 font-mono">Current Checkpoint: <strong className="text-gray-900">{trackingResult.currentLocation}</strong></span>
                        </div>
                        ...
                        <div className="flex justify-between items-center bg-gray-50 border border-gray-200 p-3 rounded-lg">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-700 font-mono">BIS Hallmarking Certificate</span>
                          </div>
                          <button 
                            ...
                            className="text-[#C5A059] hover:text-gray-900 font-bold font-mono underline text-[10px] uppercase tracking-widest"
                          >
                            Download PDF
                          </button>
                        </div>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center flex flex-col items-center gap-3">
                      ...
                      <h3 className="text-gray-900 font-bold text-sm">Requisition Reference Not Found</h3>
              ...
              <div className="border-t border-gray-200 pt-6 flex flex-col gap-4">
                <h3 className="text-xs font-bold uppercase tracking-widest text-gray-500 font-mono">Archived Requisitions</h3>
                <div className="bg-gray-50 border border-gray-200 p-4 rounded-xl flex justify-between items-center text-xs font-mono">
                  <div>
                    <span className="text-[#C5A059] font-bold block">ORD-6541</span>
                    <span className="text-[10px] text-gray-500 block mt-0.5">24K Pure Gold Bullion Coin (50g)</span>
                  </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 flex flex-col gap-8 shadow-2xl relative overflow-hidden group hover:border-[#C5A059]/50 transition-colors">
              ...
              <form onSubmit={handleSaveProfile} className="flex flex-col gap-4 font-mono text-xs">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-gray-500 uppercase tracking-widest text-[10px]">Google Gmail ID (Non-Editable)</label>
                  <input 
                    type="text" 
                    disabled
                    value={currentUserEmail || "Guest Mode - Not Signed In"} 
                    className="bg-gray-50/50 border border-gray-200 text-gray-500 text-xs rounded-xl px-4 py-3 focus:outline-none cursor-not-allowed font-bold tracking-wider"
                  />
                </div>

                <div className="flex flex-col gap-1.5">
                  <label className="text-gray-500 uppercase tracking-widest text-[10px]">Full Name</label>
                  <input 
                    type="text" 
                    required
                    ...
                    className="bg-gray-50 border border-gray-200 text-gray-900 text-xs rounded-xl px-4 py-3 focus:outline-none focus:border-[#C5A059] tracking-wider"
                  />
                </div>

                <div className="flex flex-col gap-1.5">
                  <label className="text-gray-500 uppercase tracking-widest text-[10px]">Mobile Number (For Sequel Armored OTP)</label>
                  <input 
                    type="text" 
                    required
                    ...
                    className="bg-gray-50 border border-gray-200 text-gray-900 text-xs rounded-xl px-4 py-3 focus:outline-none focus:border-[#C5A059] tracking-wider placeholder:text-gray-500"
                  />
                </div>

                <div className="flex flex-col gap-1.5">
                  <label className="text-gray-500 uppercase tracking-widest text-[10px]">Primary Armored Shipping Address</label>
                  <textarea 
                    rows={3}
                    required
                    ...
                    className="bg-gray-50 border border-gray-200 text-gray-900 text-xs rounded-xl p-4 focus:outline-none focus:border-[#C5A059] tracking-wider leading-relaxed placeholder:text-gray-500"
                  />
                </div>

                {/* Push Notification Toggle */}
                <div className="bg-gray-50 border border-gray-200 p-4 rounded-xl flex items-center justify-between mt-2 shadow-inner">
                  <div className="flex flex-col gap-0.5">
                    <span className="text-gray-900 font-bold text-xs uppercase tracking-wider flex items-center gap-1.5">
                      <span className="text-[#C5A059]">🔔</span> Live Push Notifications
                    </span>
                    <span className="text-[10px] text-gray-500 font-sans">Receive instant alerts for gold rate drops & new artisan curations.</span>
                  </div>
                  <button 
                    type="button"
                  ...
                  >
                    <div className={`bg-white w-4 h-4 rounded-full shadow-md transform transition-transform ${pushNotifications ? 'translate-x-6' : 'translate-x-0'}`}></div>
                  </button>
                </div>
              ...
              {/* Benefits Ledger */}
              <div className="bg-gray-50 border border-gray-200 p-5 rounded-xl flex flex-col gap-3 shadow-inner mt-2 font-sans">
                <h4 className="text-gray-900 font-bold text-xs uppercase tracking-wider flex items-center gap-2">
                  <span className="text-[#C5A059]">🛡️</span> Sovereign Member Privileges
                </h4>
                <div className="flex flex-col gap-2 text-[11px] text-gray-500 leading-relaxed divide-y divide-[#2A344A]">
              ...
              <div className="pt-2 flex justify-end">
                <Link 
                  href="/admin" 
                  className="text-[9px] text-[#0E1528] hover:text-gray-500 transition-colors tracking-widest font-mono"
