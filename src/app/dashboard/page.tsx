...
const CUSTOMER_NAV_ITEMS: NavItem[] = [
  { id: "overview", label: "My Overview", category: "Account" },
  { id: "orders", label: "My Orders", category: "Shopping" },
  { id: "saved", label: "Saved Items", category: "Shopping" },
  { id: "profile", label: "Profile Settings", category: "Settings" }
];
