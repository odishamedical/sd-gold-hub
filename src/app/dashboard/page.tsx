...
export default function AccountsPage() {
  ...
  const renderContent = () => {
    return (
      ...
      {/* Main Wrapper */}
      <div className="relative w-full max-w-7xl mx-auto bg-[#0A1021] rounded-none md:rounded-2xl border border-[#C5A059]/30 shadow-[0_0_40px_rgba(197,160,89,0.15)] z-10 flex flex-col overflow-hidden animate-in fade-in duration-500 my-8">
        ...
        <div className="p-4 md:p-8 flex flex-col gap-12">
          ...
          <div className="bg-gradient-to-r from-[#141C33] via-[#0E1528] to-[#141C33] border border-[#C5A059]/40 rounded-2xl p-6 md:p-8 shadow-[0_0_30px_rgba(197,160,89,0.1)] flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              ...
              <p className="text-xs md:text-sm text-gray-600 max-w-xl leading-relaxed">Manage your persistent Google Gmail authentication session, track Sequel Armored transit requisitions, and configure live push notification preferences.</p>
            </div>
            <div className="flex items-center gap-4 bg-[#0A1021] border border-gray-200 p-4 rounded-xl shadow-inner w-full md:w-auto font-sans">
               {currentUserAvatar ? (
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 flex flex-col gap-8 shadow-2xl relative overflow-hidden group hover:border-[#C5A059]/50 transition-colors">
              ...
              {searched && (
                <div className="animate-in fade-in duration-300 border-t border-gray-200 pt-6">
                  {trackingResult ? (
                    <div className="bg-[#0A1021] border border-gray-200 rounded-xl p-6 flex flex-col gap-6 shadow-inner">
              ...
              <div className="border-t border-gray-200 pt-6 flex flex-col gap-4">
                <h3 className="text-xs font-bold uppercase tracking-widest text-gray-600 font-mono">Archived Requisitions</h3>
                <div className="bg-gray-50 border border-gray-200 p-4 rounded-xl flex justify-between items-center text-xs font-mono">
                  <div>
                    ...
                    <span className="text-[10px] text-gray-600 block mt-0.5">24K Pure Gold Bullion Coin (50g)</span>
                  </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 flex flex-col gap-8 shadow-2xl relative overflow-hidden group hover:border-[#C5A059]/50 transition-colors">
              ...
              <form onSubmit={handleSaveProfile} className="flex flex-col gap-4 font-mono text-xs">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-gray-600 uppercase tracking-widest text-[10px]">Google Gmail ID (Non-Editable)</label>
                  <input 
                    type="text" 
                    disabled
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-gray-600 uppercase tracking-widest text-[10px]">Full Name</label>
                  <input 
                    type="text" 
                    required
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-gray-600 uppercase tracking-widest text-[10px]">Mobile Number (For Sequel Armored OTP)</label>
                  <input 
                    type="text" 
                    required
                    ...
                    className="bg-gray-50 border border-gray-200 text-gray-900 text-xs rounded-xl px-4 py-3 focus:outline-none focus:border-[#C5A059] tracking-wider placeholder:text-gray-600"
                  />
                </div>

                <div className="flex flex-col gap-1.5">
                  <label className="text-gray-600 uppercase tracking-widest text-[10px]">Primary Armored Shipping Address</label>
                  <textarea 
                    rows={3}
                    required
                    ...
                    className="bg-gray-50 border border-gray-200 text-gray-900 text-xs rounded-xl p-4 focus:outline-none focus:border-[#C5A059] tracking-wider leading-relaxed placeholder:text-gray-600"
                  />
                </div>
                ...
                <div className="bg-gray-50 border border-gray-200 p-4 rounded-xl flex items-center justify-between mt-2 shadow-inner">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-[10px] text-gray-600 font-sans">Receive instant alerts for gold rate drops & new artisan curations.</span>
                  </div>
                  <button 
                    type="button"
              ...
              <div className="bg-gray-50 border border-gray-200 p-5 rounded-xl flex flex-col gap-3 shadow-inner mt-2 font-sans">
                ...
                <div className="flex flex-col gap-2 text-[11px] text-gray-600 leading-relaxed divide-y divide-[#2A344A]">
