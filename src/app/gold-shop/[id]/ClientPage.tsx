    ...
    <main className="min-h-screen bg-[#060A14] text-[#E2E8F0] font-sans pb-24 relative print:hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          {/* ========================================= */}
          <div className="lg:col-span-8 lg:col-start-1 flex flex-row items-center gap-4 md:gap-6 order-1">
          ...
          {/* ========================================= */}
          {/* RIGHT SIDEBAR (Order 2 on Mobile, Right Col on PC) */}
          {/* ========================================= */}
          <aside className="lg:col-span-4 lg:col-start-9 lg:row-span-3 w-full flex flex-col gap-6 relative z-10 order-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 rounded-2xl overflow-hidden mt-2 border border-white/5 shadow-2xl">
              {Array.from({ length: 5 }).map((_, i) => {
                const img = shop.coverImages?.[i] || "https://placehold.co/600x400/0A0F1C/333333.png?text=Add+Photo";
                return (
                  <div key={i} className={`bg-[#0A0F1C] relative group overflow-hidden ${i === 0 ? 'col-span-2 row-span-2 aspect-square' : 'col-span-1 row-span-1 aspect-square'}`}>
                    <img src={getProxiedImageUrl(img, "https://placehold.co/600x400/0A0F1C/333333.png?text=Add+Photo")} className="w-full h-full object-cover opacity-90 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" alt={`Showroom ${i+1}`} onError={(e) => { (e.target as HTMLImageElement).src = `https://placehold.co/600x400/0A0F1C/333333.png?text=Add+Photo`; }} />
          ...
          {/* ========================================= */}
          <div className="lg:col-span-8 lg:col-start-1 flex flex-col gap-4 md:gap-6 order-4 mt-4 lg:mt-0">
          ...
          {/* ========================================= */}
              <div className="mt-8 text-center border-t border-[#2A344A] pt-8">
                <p className="text-gray-400 text-sm mb-4">Want to see more from {shop.name}?</p>
                <div className="flex flex-col md:flex-row items-center justify-center gap-4">
                  <a href={`tel:${shop.phone || '+918093123456'}`} className="bg-[#141C33] border border-[#2A344A] text-white px-6 py-3 rounded-xl hover:border-[#C5A059] transition-all flex items-center gap-2">
                    <Phone className="w-4 h-4 text-[#C5A059]" /> Call Showroom
                  </a>
                  <a href={`https://wa.me/${shop.whatsappNumber || shop.phone}?text=Hi, I want to explore more jewelry collections.`} target="_blank" rel="noopener noreferrer" className="bg-[#128C7E]/10 border border-[#128C7E]/30 text-[#25D366] px-6 py-3 rounded-xl hover:bg-[#128C7E]/20 transition-all flex items-center gap-2">
              ...
              <div className="w-full relative group">
                ...
                <div className="bg-gradient-to-br from-emerald-900/30 to-[#0A0F1C]/80 backdrop-blur-xl border border-[#FFB6C1]/40 shadow-[0_10px_40px_rgba(0,0,0,0.6)] rounded-2xl p-4 flex flex-col items-center justify-center relative overflow-hidden ring-1 ring-inset ring-[#FFB6C1]/20 hover:border-[#FFB6C1]/60 transition-colors group-hover:scale-[1.02] duration-300">
                  <Image src="/stock/claim-ticket-bg.png" alt="Velvet Background" fill className="object-cover opacity-80 mix-blend-overlay pointer-events-none"   onError={(e) => { (e.target as HTMLImageElement).srcset = ""; (e.target as HTMLImageElement).src = `https://placehold.co/600x400/0A0F1C/333333.png?text=Add+Photo`; }} />
...
{/* Sticky Global Banner Ad */}
          ...
          <div className="lg:col-span-8 lg:col-start-1 flex flex-col gap-4 md:gap-6 order-3">
            ...
            {/* Our Heritage */}
            <div className="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 md:mt-4 shadow-lg relative overflow-hidden">
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#D4AF37] opacity-[0.03] blur-[60px] rounded-full pointer-events-none" />
