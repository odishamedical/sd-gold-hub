    ...
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-8">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <button 
            ...
            className="flex-1 md:flex-none px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl text-xs font-bold uppercase tracking-widest text-gray-900 hover:border-[#C5A059] hover:text-[#C5A059] transition-all shadow flex items-center justify-center gap-2"
          >
      ...
      <div className="flex gap-8 border-b border-gray-200 mb-8">
        <button 
          ...
          className={`pb-4 text-sm font-bold uppercase tracking-widest transition-colors relative ${activeTab === "pending" ? "text-[#C5A059]" : "text-gray-500 hover:text-gray-900"}`}
        >
          Pending Approvals
        ...
        <button 
          ...
          className={`pb-4 text-sm font-bold uppercase tracking-widest transition-colors relative ${activeTab === "active" ? "text-[#C5A059]" : "text-gray-500 hover:text-gray-900"}`}
        >
          Active Vendors
      ...
      {activeTab === "pending" && (
        <div className="space-y-6">
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-lg relative overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              <div className="flex items-center gap-6">
                <div className="w-16 h-16 rounded-xl bg-gray-50 border border-[#C5A059]/30 flex items-center justify-center text-2xl">
                  ✨
                </div>
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-1">Glow Jewellers</h3>
              ...
              <div className="flex items-center gap-3 w-full md:w-auto">
                <button className="flex-1 md:flex-none px-6 py-3 border border-gray-200 rounded-xl text-xs font-bold uppercase tracking-widest text-gray-900 hover:border-[#C5A059] transition-colors bg-gray-50">
                  Verify Docs
                </button>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <p className="font-mono text-sm text-gray-900">22AAAAA0000A1Z5</p>
              </div>
              <div>
                <p className="text-[10px] text-gray-500 uppercase tracking-widest mb-1">BIS Hallmark ID</p>
                <p className="font-mono text-sm text-gray-900">HM/C-1234567</p>
              </div>
              <div>
      ...
      {activeTab === "active" && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in duration-500">
          {/* Mock active vendors */}
          <div className="bg-white border border-gray-200 rounded-2xl p-6 hover:border-[#C5A059]/50 transition-colors cursor-pointer group">
            <div className="flex justify-between items-start mb-6">
              <div className="w-12 h-12 rounded-full bg-gray-50 border border-[#C5A059] overflow-hidden flex items-center justify-center text-[#C5A059] font-bold group-hover:scale-110 transition-transform">
                IJ
              </div>
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-1">IRA Jewels</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 hover:border-[#C5A059]/50 transition-colors cursor-pointer group">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-1">Dwarika Jewellers</h3>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-in fade-in duration-300">
          <div className="bg-white border border-[#C5A059] rounded-2xl p-8 max-w-md w-full shadow-[0_0_50px_rgba(197,160,89,0.2)] relative">
            <button 
              ...
              className="absolute top-4 right-4 text-gray-500 hover:text-gray-900 transition-colors w-8 h-8 rounded-full bg-gray-50 border border-gray-200 flex items-center justify-center"
            >
              ✕
            </button>
            <h2 className="text-xl font-serif text-[#C5A059] font-bold mb-1">Provision Vendor Node</h2>
            <p className="text-xs text-gray-500 mb-6">Bypass application queue and instantly provision a secure merchant node.</p>

            <form onSubmit={handleProvisionVendor} className="space-y-4 font-mono text-xs">
              <div className="flex flex-col gap-1">
                <label className="text-gray-500 uppercase tracking-widest text-[10px]">Registered Store Name</label>
                <input 
                  type="text" 
                  required
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500 uppercase tracking-widest text-[10px]">Official GSTIN Number</label>
                <input 
                  type="text" 
                  required
                  ...
                  className="bg-gray-50 border border-gray-200 text-gray-900 rounded-xl px-4 py-3 focus:outline-none focus:border-[#C5A059] uppercase tracking-wider"
                />
              </div>

              <div className="flex flex-col gap-1">
                <label className="text-gray-500 uppercase tracking-widest text-[10px]">Merchant Owner Email</label>
                <input 
                  type="email" 
                  required
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500 uppercase tracking-widest text-[10px]">Clearance Tier</label>
                <select 
                  value={vendorTier} 
      ...
      {showStaffModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-in fade-in duration-300">
          <div className="bg-white border border-[#C5A059] rounded-2xl p-8 max-w-md w-full shadow-[0_0_50px_rgba(197,160,89,0.2)] relative">
            ...
            <p className="text-xs text-gray-500 mb-6">Assign delegated governance clearance (Admin or Manager).</p>

            <form onSubmit={handleOnboardStaff} className="space-y-4 font-mono text-xs">
              <div className="flex flex-col gap-1">
                <label className="text-gray-500 uppercase tracking-widest text-[10px]">Staff Full Name</label>
                <input 
                  type="text" 
                  required
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500 uppercase tracking-widest text-[10px]">Official Corporate Email</label>
                <input 
                  type="email" 
                  required
              ...
              <div className="flex flex-col gap-1">
                <label className="text-gray-500 uppercase tracking-widest text-[10px]">Delegated Role Tag</label>
                <select 
                  value={staffRole} 
                  onChange={(e) => setStaffRole(e.target.value)}
                  className="bg-gray-50 border border-[#C5A059]/50 text-gray-900 rounded-xl px-4 py-3 focus:outline-none focus:border-[#C5A059]"
                >
              ...
              <div className="bg-gray-50 p-3 rounded-xl border border-gray-200 text-[10px] text-gray-500 leading-relaxed mt-2">
              ...
              <button 
                type="submit"
                className="w-full py-4 rounded-xl bg-gradient-to-r from-[#141C33] via-[#C5A059] to-[#141C33] border border-[#C5A059] text-gray-900 font-bold uppercase tracking-widest hover:brightness-110 transition-all shadow-xl mt-6 font-sans"
              >
