      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <aside className="w-full lg:w-[340px] shrink-0 flex flex-col gap-6 relative">
            ...
            {/* The High-Conversion Action Box (Rose Gold Glassmorphism) */}
            <div className="bg-gradient-to-b from-[#1A0B0E] to-[#0A0506] border border-[#B76E79]/40 shadow-[0_0_30px_rgba(183,110,121,0.15)] rounded-3xl p-6 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFB6C1] opacity-[0.08] blur-[40px] rounded-full pointer-events-none" />
              ...
              <div className="space-y-3">
                 ...
                 {shop.phone && (
                   <div className="flex gap-3">
                     ...
                     <a href={`https://wa.me/${shop.phone.replace(/\D/g,'')}`} target="_blank" rel="noreferrer" className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-green-500 to-green-400 text-black py-3 rounded-xl font-bold text-[10px] uppercase tracking-widest transition-all shadow-[0_4px_15px_rgba(34,197,94,0.3)] hover:scale-[1.02]">
