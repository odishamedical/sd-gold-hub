...
export default function AdsPage() {
  ...
  const handleEdit = (campaign: AdCampaign) => {
    ...
    setTargetLocation(campaign.targetLocation || "all");
    ...
    <div className="space-y-6">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <button 
          ...
          className="px-6 py-3 bg-[#C5A059] text-[#060A14] rounded-xl text-sm font-bold shadow-[0_4px_14px_0_rgb(0,0,0,0.39)] hover:shadow-[0_6px_20px_rgba(197,160,89,0.23)] hover:bg-[#b08d4f] transition-all flex items-center gap-2"
        >
                ...
                campaigns.map(banner => {
                  ...
                  return (
                    <tr key={banner.id} className="group hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-4 px-4">
                        <div className="text-xs font-bold text-[#C5A059] bg-[#C5A059]/10 px-2 py-1 rounded-md inline-block">
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleCreate} className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-[#C5A059] uppercase tracking-widest border-b pb-2">1. Campaign Details</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-[#C5A059] uppercase tracking-widest border-b pb-2">2. Targeting Rules</h3>
                ...
                <div className="mt-4">
                  <label className="block text-xs font-bold text-gray-700 mb-1">Target Location (City/State)</label>
                  <input type="text" value={targetLocation} onChange={e => setTargetLocation(e.target.value)} className="w-full px-4 py-2 bg-white border-2 border-gray-300 shadow-sm font-medium focus:ring-4 focus:ring-[#0070F3]/15 rounded-lg text-sm" placeholder="e.g. all, Mumbai, Maharashtra" />
                  <p className="text-[10px] text-gray-500 mt-1">If "all", the ad will show globally. Otherwise it will try to match the user's location via geolocation.</p>
                </div>
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-[#C5A059] uppercase tracking-widest border-b pb-2">3. Ad Content</h3>
              ...
              <div className="pt-4 flex justify-end gap-3 border-t border-gray-100">
                ...
                <button type="submit" disabled={isUploading} className="px-5 py-2.5 bg-[#C5A059] text-[#060A14] font-bold text-sm rounded-xl hover:bg-[#b08d4f] disabled:opacity-50">
