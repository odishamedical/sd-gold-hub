          ...
          <div className="space-y-6">
            ...
            <div className="pt-4 border-t border-[#2A344A]">
              <div className="flex items-center gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-[#141C33] border border-[#2A344A] flex items-center justify-center text-slate-400 hover:bg-[#C5A059] hover:text-[#060A14] hover:border-[#C5A059] transition-all">
