...
export default function GlobalFooter() {
  ...
  return (
    <footer className="relative border-t border-[#C5A059]/20 pt-16 pb-8 z-40 overflow-hidden">
      {/* Background Image Layer */}
      <div className="absolute inset-0 bg-[url('/hero-gold.png')] bg-cover bg-center opacity-20 mix-blend-luminosity pointer-events-none"></div>
      <div className="absolute inset-0 bg-[#060A14]/85 backdrop-blur-2xl pointer-events-none"></div>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mb-8">
          ...
          <div className="space-y-6 lg:col-span-4">
            ...
            {/* Social Media moved here to balance column heights */}
            <div className="pt-4 flex items-center gap-4">
              <a href="https://instagram.com/shyamdash" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:scale-110 hover:border-[#E1306C] hover:bg-[#E1306C]/10 transition-all group backdrop-blur-sm">
              ...
              <a href="https://www.facebook.com/oltamind" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:scale-110 hover:border-[#1877F2] hover:bg-[#1877F2]/10 transition-all group backdrop-blur-sm">
              ...
              <a href="https://youtube.com/@shyamdashlive" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:scale-110 hover:border-[#FF0000] hover:bg-[#FF0000]/10 transition-all group backdrop-blur-sm">
          ...
          {/* Corporate Links */}
          <div className="lg:col-span-2 lg:pl-4 border-b border-white/5 md:border-none pb-4 md:pb-0">
            <button 
            ...
            <ul className={`space-y-4 md:space-y-3 mt-4 md:mt-6 transition-all overflow-hidden ${openSection === 'corporate' ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 md:max-h-96 md:opacity-100'}`}>
              ...
              <li><Link href="/directory" className="text-sm text-slate-300 hover:text-[#C5A059] transition-colors flex items-center gap-2"><span className="w-1 h-1 rounded-full bg-[#C5A059]/50"></span>Master Directory</Link></li>
            </ul>
          </div>

          {/* Legal & Compliance */}
          <div className="lg:col-span-3 border-b border-white/5 md:border-none pb-4 md:pb-0">
            <button 
            ...
            <ul className={`space-y-4 md:space-y-3 mt-4 md:mt-6 transition-all overflow-hidden ${openSection === 'legal' ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 md:max-h-96 md:opacity-100'}`}>
              <li><Link href="/privacy" className="text-sm text-slate-300 hover:text-[#C5A059] transition-colors flex items-center gap-2"><span className="w-1 h-1 rounded-full bg-[#C5A059]/50"></span>Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-sm text-slate-300 hover:text-[#C5A059] transition-colors flex items-center gap-2"><span className="w-1 h-1 rounded-full bg-[#C5A059]/50"></span>Terms & Conditions</Link></li>
              <li><Link href="/refund-policy" className="text-sm text-slate-300 hover:text-[#C5A059] transition-colors flex items-center gap-2"><span className="w-1 h-1 rounded-full bg-[#C5A059]/50"></span>Cancellation & Refunds</Link></li>
              <li><Link href="/shipping" className="text-sm text-slate-300 hover:text-[#C5A059] transition-colors flex items-center gap-2"><span className="w-1 h-1 rounded-full bg-[#C5A059]/50"></span>Shipping & Delivery</Link></li>
              <li><Link href="/sell-with-us" className="text-sm text-slate-300 hover:text-[#C5A059] transition-colors flex items-center gap-2"><span className="w-1 h-1 rounded-full bg-[#C5A059]/50"></span>Vendor Registration</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 border-b border-white/5 md:border-none pb-4 md:pb-0">
            ...
            <ul className={`space-y-6 mt-4 md:mt-6 transition-all overflow-hidden ${openSection === 'support' ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0 md:max-h-[500px] md:opacity-100'}`}>
              <li>
                <a href="mailto:support@golddunia.com" className="group flex items-start gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 hover:border-[#C5A059]/30 transition-all backdrop-blur-sm">
