          ...
          <div className="space-y-6 lg:col-span-3">
            ...
            <div className="pt-4 border-t border-[#2A344A]">
              <div className="flex items-center gap-4">
                ...
                <a href="https://facebook.com/olatmind" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-[#141C33] border border-[#2A344A] flex items-center justify-center hover:scale-110 hover:border-[#1877F2] transition-all">
